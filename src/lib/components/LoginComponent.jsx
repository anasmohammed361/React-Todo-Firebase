...
import { logIn,continueWithGoogle } from "../scripts/auth/auth"
const LoginComponent = () => {
  ...
  <div>
                ...
                <button onClick={handleLogin} type="submit" className="hover:shadow shadow-lg group relative w-full flex mt-14 justify-center  p-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition-all">
                    Login
                </button>
            </div>
